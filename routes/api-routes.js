  ...
  app.get("/api/beaches", (req, res) => {
    ...
    axios({
      ...
      for (let index = 0; index < beachArr.length; index++) {
        ...
        db.beachInfo.create({
          county: beachData.county_region,
          siteName: beachData.site_name,
          address: beachData.address,
          latitude: beachData.latitude,
          longitude: beachData.longitude,
          website: beachData.website,
          startTime: beachData.start_time,
          endTime: beachData.end_time,
          whatToBring: beachData.What_to_bring,
          organization: beachData.organization,
          phone: beachData.phone,
          email: beachData.email
        });
      }
